...
void AddIMPPersonalityQuizAnswerButtons( INT32 iNumberOfButtons )
{
	...
	switch( iCounter )
		...
		swprintf( sString, JA2_TEXT("%d"), iCounter + 1 );
...
void PrintQuizQuestionNumber( void )
{
	...
	swprintf(sString, JA2_TEXT("%d"), giCurrentPersonalityQuizQuestion + 1);

	// print current question number
	mprintf( LAPTOP_SCREEN_UL_X + 345 , LAPTOP_SCREEN_WEB_UL_Y + 370 ,sString);

	// total number of questions
	mprintf( LAPTOP_SCREEN_UL_X + 383 , LAPTOP_SCREEN_WEB_UL_Y + 370 , JA2_TEXT("16"));
	return;
}
