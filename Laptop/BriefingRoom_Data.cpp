 ...
 CHAR8 fileNameEdt[80];
  ...
  P2[0] = 0;
	...
	if ( FileExists(fileNameEdt)  )
		...
		DisplayWrappedString(ENCYCLOPEDIA_LOCATION_BOX_X+ENCYCLOPEDIA_LOCATION_BOX_SHADOW_GAP + 3, ENCYCLOPEDIA_LOCATION_BOX_Y + 18 + ENCYCLOPEDIA_LOCATION_BOX_SHADOW_GAP - 50, ENCYCLOPEDIA_LOCATION_BOX_TEXT_WIDTH, 6, ENCYCLOPEDIA_LOCATION_BOX_FONT, ENCYCLOPEDIA_LOCATION_BOX_COLOR, JA2_TEXT(""), FONT_MCOLOR_BLACK, FALSE, LEFT_JUSTIFIED);
...
*/
	...
	*/
	...
	//reset
	if ( ResetVal == TRUE )
	usStringPixLength = StringPixLength( JA2_TEXT(""), ENCYCLOPEDIA_LOCATION_BOX_FONT);
	...
	//Reset
	if ( ResetVal == TRUE )
	   DisplayWrappedString(ENCYCLOPEDIA_LOCATION_BOX_DESC_X, ENCYCLOPEDIA_LOCATION_BOX_DESC_Y + 13, ENCYCLOPEDIA_LOCATION_BOX_TEXT_WIDTH, 6, ENCYCLOPEDIA_LOCATION_BOX_FONT, ENCYCLOPEDIA_LOCATION_BOX_COLOR, JA2_TEXT(""), FONT_MCOLOR_BLACK, FALSE, LEFT_JUSTIFIED);
