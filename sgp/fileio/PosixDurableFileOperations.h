#ifndef JA2_FILEIO_POSIXDURABLEFILEOPERATIONS_H
#define JA2_FILEIO_POSIXDURABLEFILEOPERATIONS_H
...
class PosixDurableFileOperations final : public DurableFileOperations
{
public:
	explicit PosixDurableFileOperations(const PhysicalWritableStore& store);
