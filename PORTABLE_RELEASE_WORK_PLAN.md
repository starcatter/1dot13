...
| R8 | Strategic route and battle-state validation | strategic paths, groups, map arrival and encounter state; alert-aware tactical withdrawal follow-up | Deterministic squad/vehicle/helicopter/militia scenarios and assertions for route lifetime and encounter preservation; design for unalerted groups exiting through the travel-direction map edge | none |
